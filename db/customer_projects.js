...
export async function createCustomerProject({ customer_id, title, description = null }) {
...
export async function updateCustomerProjectById({ id, title, description = null }) {
